...
class Block(nn.Module):
    ...
    def __init__(self, num_heads: int, block_size: int, n_embedd: int = 32, device: str = None, attention_head_size: int = 16, dropout: float = 0.2):
        ...
        self.ffn = FeedForward(attention_head_size=attention_head_size, dropout = dropout)

        # Layer normalisation
        self.ln1 = nn.LayerNorm(attention_head_size)
        self.ln2 = nn.LayerNorm(attention_head_size)
